    ...
    <div class="main">
      <div class="panel">
        ...
        <div class="panel-body inner">
          <h4 class="heading4">Quiz description:</h4>
      ...
      <div class="panel">
        <div class="panel-head">
          <span class="button button-success"><span class="abc-add"></span>New Quiz</span>
        </div>
        <div class="panel-body inner">
          <div class="line clearfix">
            Week 1 Lecture: 1, 2, 3 John
            <div class="line-actions icons">
              <span class="abc-arrow-down"></span>
              <span class="abc-arrow-up"></span>
              <?php include 'part/button/edit.php'; ?>
              <?php include 'part/button/delete.php'; ?>
              <span class="button button-normal">Grades</span>
            </div>
          </div>
          <div class="line clearfix">
            Revelation 5-22
          ...
          <div class="line clearfix">
            WETIA's Education Technology Video
            <div class="line-actions icons">
              <span class="abc-arrow-down"></span>
              <span class="abc-arrow-up"></span>
              <?php include 'part/button/edit.php'; ?>
